-- Sample portfolio data (PostgreSQL)
-- Truncate and reload for a clean slate, or run once on empty tables.
--
...
-- IMPORTANT: contact_messages is intentionally NOT deleted so reloading
...
--     'Java 17, Spring Boot, PostgreSQL, Angular, Docker',
--     1
-- );
--
